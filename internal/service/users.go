...
func (s *UserService) RefreshTokens(ctx context.Context, token string) (Tokens, error) {
...
func (s *UserService) createSession(ctx context.Context, userID int, token string) (Tokens, error) {
	var (
		res Tokens
		err error
	)
